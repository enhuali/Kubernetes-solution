...
工作目录处于[images/image_php7.0.16](images/image_php7.0.16)
...
#制作镜像
docker build -t Harbor_ip:Port/Group/php7.0.16 .
```
...
mongodb											MongoDB extension version => 1.2.5
